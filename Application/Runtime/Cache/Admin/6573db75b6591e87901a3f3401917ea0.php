...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<form action="/tp/index.php/Admin/Navigation/cate_sort" method="post">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" href="/tp/index.php/Admin/Navigation/cate_add">添加导航</a>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="4%">排序</th>
							<th width="4%">ID</th>
							<th width="400">导航名称</th>
						    <th>时间</th>
							<th width="120">操作</th>
						</tr>
					</thead>
					<tbody>
					    <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td class="f-14 td-manage">
								<a onClick="return confirm('确定要删除导航吗')" href="/tp/index.php/Admin/Navigation/cate_del/id/<?php echo ($vo["id"]); ?>">删除</a>
								<a onClick="return confirm('确定要修改导航吗')" href="/tp/index.php/Admin/Navigation/cate_edit/id/<?php echo ($vo["id"]); ?>">修改</a>
							</td>
