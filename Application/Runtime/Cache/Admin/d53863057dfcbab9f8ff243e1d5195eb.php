...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>导航标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" name="id" value="<?php echo ($cates["id"]); ?>">
				<input type="text" class="input-text" value="<?php echo ($cates["catename"]); ?>" placeholder="" id="catename" name="catename">
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onClick="javascript:location.replace(location.href);" class="btn btn-secondary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 重新修改</button>
