...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<form action="/tp/index.php/Admin/Like/cate_sort" method="post">
		<article class="cl pd-20">
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
					    <?php if(is_array($likes)): $i = 0; $__LIST__ = $likes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
							<td><input type="checkbox" value="" name=""></td>
							<td><?php echo ($vo["user"]); ?></td>
							<td><?php echo ($vo["content"]); ?></td>
							<td><?php echo ($vo["time"]); ?></td>
							<td class="f-14 td-manage">
								<a  href="/tp/index.php/Admin/Like/like_huifu/id/<?php echo ($vo["id"]); ?>">回复</a>
							</td>
