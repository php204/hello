...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<form action="/tp/index.php/Admin/Cate/cate_sort" method="post">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" href="/tp/index.php/Admin/Cate/cate_add">添加栏目</a>
					...
					<tbody>
					    <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td class="f-14 td-manage">
								<a onClick="return confirm('确定要删除栏目吗')" href="/tp/index.php/Admin/Cate/cate_del/id/<?php echo ($vo["id"]); ?>">删除</a>
								<a onClick="return confirm('确定要修改栏目吗')" href="/tp/index.php/Admin/Cate/cate_edit/id/<?php echo ($vo["id"]); ?>">修改</a>
							</td>
