	...
	<div class="Hui-article">
		...
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" href="/tp/index.php/Admin/Logo/article_add">添加文章</a>
				</span>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
					    <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
								...
								<a onClick="return confirm('确定要删除栏目吗')" href="/tp/index.php/Admin/Logo/article_del/id/<?php echo ($vo["id"]); ?>">删除</a>
								<a onClick="return confirm('确定要修改栏目吗')" href="/tp/index.php/Admin/Logo/article_edit/id/<?php echo ($vo["id"]); ?>">修改</a>
							</td>
