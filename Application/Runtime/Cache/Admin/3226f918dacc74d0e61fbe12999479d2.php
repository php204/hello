...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<form action="/tp/index.php/Admin/Admin/admin_sort" method="post">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" href="/tp/index.php/Admin/Admin/admin_add">添加管理员</a>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
					    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
								<td><input type="checkbox" value="" name="del"></td>
								<td><input type="text" name="<?php echo ($vo["id"]); ?>" style="width:20px;height:20px"  value="<?php echo ($vo["sort"]); ?>" ;></td>
								<td><?php echo ($vo["id"]); ?></td>
								<td title="<?php echo ($vo["username"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["username"]); ?>"><?php echo ($vo["username"]); ?></a></td>
								<td class="f-14 td-manage">
							<?php if($vo[id] != 1): ?><a onClick="return confirm('确定要删除栏目吗')" href="/tp/index.php/Admin/Admin/admin_del/id/<?php echo ($vo["id"]); ?>">删除</a><?php endif; ?>
								<a onClick="return confirm('确定要修改栏目吗')" href="/tp/index.php/Admin/Admin/admin_edit/id/<?php echo ($vo["id"]); ?>">修改</a>
							</td>
