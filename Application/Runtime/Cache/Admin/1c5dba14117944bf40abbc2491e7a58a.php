		...
		<article class="cl pd-20">
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
					    <?php if(is_array($pls)): $i = 0; $__LIST__ = $pls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
							<td><input type="checkbox" value="" name=""></td>
							<td><?php echo ($vo["title"]); ?></td>
							<td><?php echo ($vo["catename"]); ?></td>
							<td><?php echo (date("Y-m-d H:i:s",$vo["time"])); ?></td>
							<td class="f-14 td-manage">
								<a  href="/tp/index.php/Admin/Like/like_lists/id/<?php echo ($vo["id"]); ?>">所有评论</a>
							</td>
