...
<header>
  <div id="mnav">
    ...
    <ul id="starlist">
      ...
      <!-- 数据调用 -->
      <?php if(is_array($navigations)): $i = 0; $__LIST__ = $navigations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/tp/index.php/Home/cate/list/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="newblogs">
      <h2 class="hometitle">
        <span>
           ...
           <?php if(is_array($catename)): foreach($catename as $key=>$vo): ?><a href="/tp/index.php/Home/cate/list/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a><?php endforeach; endif; ?>
      ...
      <ul>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              ...
              <div class="bloginfo"><span class="blogpic"><a href="/tp/index.php/Home/Article/info/id/<?php echo ($vo["id"]); ?>" title=""><img src="/tp/<?php echo ($vo["pic"]); ?>"  /></a></span>
                <p><?php echo ($vo["desc"]); ?></p>
              </div>
              <div class="autor"><span class="lm f_l"><a href="/">叶贵丰个人博客</a></span><span class="dtime f_l"><?php echo (date("Y-m-d",$vo["time"])); ?></span><span class="viewnum f_l">浏览<a href="/"><?php echo ($vo["sum"]); ?></a>次</span><span class="pingl f_l">评论（<a href="/">30</a>）</span><span class="f_r"><a href="/tp/index.php/Home/article/info/id/<?php echo ($vo["id"]); ?>" class="more">阅读原文>></a></span></div>
