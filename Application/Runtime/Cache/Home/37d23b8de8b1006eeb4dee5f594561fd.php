...
<header>
  <div id="mnav">
    ...
    <ul id="starlist">
      ...
      <!-- 数据调用 -->
      <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/tp/index.php/Home/Cate/Cate/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="leftbox">
    <div class="infos">
      <div class="newsview">
        ...
        <div class="news_infos">
          ...
          <p><img src="http://127.0.0.1/tp/Application/Home/Public/images/v1.jpg"></p>
          ...
          <p><img src="http://127.0.0.1/tp/Application/Home/Public/images/v2.jpg"></p>
      ...
      <div class="shang_box" style="display: none;"> <a class="shang_close" href="javascript:void(0)" onclick="dashangToggle()" title="关闭">关闭</a>
        ...
        <div class="shang_payimg"> <img src="http://127.0.0.1/tp/Application/Home/Public/images/alipayimg.jpg" alt="扫码支持" title="扫一扫"> </div>
        <div class="pay_explain">扫码打赏，你说多少就多少</div>
        <div class="shang_payselect">
          <div class="pay_item checked" data-id="alipay"> <span class="radiobox"></span> <span class="pay_logo"><img src="http://127.0.0.1/tp/Application/Home/Public/images/alipay.jpg" alt="支付宝"></span> </div>
          <div class="pay_item" data-id="weipay"> <span class="radiobox"></span> <span class="pay_logo"><img src="http://127.0.0.1/tp/Application/Home/Public/images/wechat.jpg" alt="微信"></span> </div>
        </div>
    ...
    $(function(){
      $(".pay_item").click(function(){
        ...
        $(".shang_payimg img").attr("src","http://127.0.0.1/tp/Application/Home/Public/images/"+dataid+"img.jpg");
    ...
    <!--share end-->
    <div class="zsm"><p>打赏本站，你说多少就多少</p><img src="http://127.0.0.1/tp/Application/Home/Public/images/zsm.jpg"></div>
    </div>
    <div class="nextinfo">
    ...
    <div class="paihang">
      ...
      <ul>
        <li><b><a href="/jstt/css3/2018-03-20/808.html" target="_blank">十条设计原则教你学会如何设计网页布局!...</a></b>
          <p><i><img src="http://127.0.0.1/tp/Application/Home/Public/images/b01.png"></i>网页常见的布局有很多种,单列布局,多列布局.其中单列布局是国外很多网站比较常用的.咱们很多站长以及门户...</p>
        </li>
        <li><b><a href="/" target="_blank">教你怎样用欠费手机拨打电话</a></b>
          <p><i><img src="http://127.0.0.1/tp/Application/Home/Public/images/b02.jpg"></i>对于刚毕业的学生来说，想学习建网站，掌握一技之长，最简单的入门...</p>
        </li>
        <li><b><a href="/" target="_blank">原来以为，一个人的勇敢是，删掉他的手机号码</a></b>
          <p><i><img src="http://127.0.0.1/tp/Application/Home/Public/images/b03.jpg"></i>先前发表过一篇文章《如果要学习web前端开发，需要学习什么？》</p>
        </li>
        <li><b><a href="/" target="_blank">手机的16个惊人小秘密，据说99.999%的人都不知</a></b>
          <p><i><img src="http://127.0.0.1/tp/Application/Home/Public/images/b04.jpg"></i>对于刚毕业的学生来说，.需要学习什么？》</p>
        </li>
        <li><b><a href="/" target="_blank">你面对的是生活而不是手机</a></b>
          <p><i><img src="http://127.0.0.1/tp/Application/Home/Public/images/b05.jpg"></i>最简单的入门无非就是学会html和css，先前发表过一篇文章...</p>
        </li>
      </ul>
    </div>
    <div class="links">
