 ...
 //栏目添加页面转跳及验证
   ...
   //栏目排序
    public function cate_sort(){
         ...
         $this->success('排序成功',U('article_list'));
    ...
    public function article_del(){
         $cate=D('article');
         if ($cate->delete(I('id'))) {
             $this->success('删除成功',U('article_list'));
         }else{
             $this->error('删除失败',U('article_list'));
         } 
    ...
    public function article_del_all(){
                  ...
                  //接受删除的ID
                   ...
                   if($n){
                        $this->success('删除成功',U('article_list'),3);
                    }else{
                        $this->error('删除失败',U('article_list'),3);
                    }
